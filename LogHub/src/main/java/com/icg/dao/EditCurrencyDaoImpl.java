...
public class EditCurrencyDaoImpl implements EditCurrencyDao {
	...
	public String editCurrency(Currency currency) {
		String status;
		System.out.println("in edit daoimpl ");
		...
		String url = null;
		try {
			url = MessageExtension.BASE_URL+"editCurrency?currencyName="+URLEncoder.encode(currency.getCurrencyName(),"UTF-8")+"&currencyValue="+currency.getCurrencyValue()+"";
